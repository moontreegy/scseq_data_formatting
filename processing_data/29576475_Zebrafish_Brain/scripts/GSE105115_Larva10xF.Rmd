...
# str(mat)
load("../raw_data/29576475_Zebrafish_Brain.RObj")
mat <- Larva10xF@raw.data

# metadata
# metadata_path <- paste0(raw_data, "LL3_low_res_identity.csv")
# metadata <- read.csv(metadata_path, header = TRUE)
metadata <- Larva10xF@data.info
str(metadata)
unique(metadata$res.0.5)
...
* Update output file name from Matrix to gene2clusterTable
* Add one more output file clusterMetadataTable
