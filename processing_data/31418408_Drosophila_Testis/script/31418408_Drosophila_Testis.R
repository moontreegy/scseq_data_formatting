...
seuratObj<-readRDS(paste0(path.raw.data,"200716_2019elife_testisRDS.rds"))
SCSeq.mtx<-as.array(GetAssayData(object = seuratObj, assay = "RNA", slot = "counts"))
dim(SCSeq.mtx)
SCSeq.mtx[1:3, 1:3]


# metadata
metadata<-read.delim(paste0(path.raw.data, "200716_cell_metadata.txt"),
